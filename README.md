...
THe following classes make up the project:
Creature: It represents one individual animal. It has metadata for the creature such as stats,parent reference, age, health, ASCII art string

Species: It defines the species. wife properties. It includes the following data, base stats, Species name, the food chain role it has, ASCII art template.
